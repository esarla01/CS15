...
private:
        ...
        Node *new_Node(int value, int count) const;
        ...
        void remove_helper_rootnode(Node *node);
        void remove_helper_0children(Node *node, Node *parent, int value);
        void remove_helper_1child(Node *node, Node *parent, int value);
        void remove_helper_2children(Node *node);
